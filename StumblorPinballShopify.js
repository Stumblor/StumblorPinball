$( document ).ready(function() {
  ...
  var css = [
    ...
    div[data-block-purpose="text-and-image@^1.0.0"] .button-wrapper { text-align: center; }
  ...
  setInterval(() => {
    ...
    if (url != urlwas) {
      if (url == "https://www.stumblorpinball.com/" ||
         url == "https://stumblor-pinball.myshopify.com/") {
        // landing page
        //stories();
        quotes("#shopify-section-template--14215494598730__163541565173913438");
      }
